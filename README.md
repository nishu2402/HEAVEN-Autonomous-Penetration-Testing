...
<picture>
  ...
  <img src="docs/assets/heaven-poster.svg" width="100%" alt="HEAVEN: Autonomous Penetration-Testing Framework · Recon → ML Risk Scoring → Verified Exploitation → Reporting · 2904 tests · 62 CLI commands · 99 API routes · 30 UI pages · 15 scan modes · hybrid CVSS ML predictor R²=0.91 · LLM observe→plan→act with deterministic fallback (no API key required)"/>
</picture>
</p>
...
| Metric | Value |
|---|---|
| 🧪 **Tests** | 2904 tests (pytest matrix: Python 3.11 / 3.12) |
...
tests/                    2904 pytest tests + native & DVWA benchmark suites
...
pytest tests/                  # full suite, ~3.5 min (2904 tests)
...
<p align="center">
<strong>2904 tests · 219 modules · 62 CLI commands · 99 API routes · 30 UI pages · PostgreSQL + SQLite · MIT</strong>
</p>
