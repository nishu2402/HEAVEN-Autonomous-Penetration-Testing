...
| Metric | Value |
|---|---|
| 🧪 **Tests** | 1074 tests (pytest matrix: Python 3.11 / 3.12) |
...
tests/                    1074 pytest tests + native & DVWA benchmark suites
...
<p align="center">
<strong>1074 tests · 148 modules · 50 CLI commands · 64 API routes · 24 UI pages · PostgreSQL + SQLite · MIT</strong>
