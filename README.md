...
<picture>
  ...
  <img src="docs/assets/heaven-poster.svg" width="100%" alt="HEAVEN: Autonomous Penetration-Testing Framework · Recon → ML Risk Scoring → Verified Exploitation → Reporting · 2768 tests · 62 CLI commands · 99 API routes · 25 UI pages · 16 scan modes · hybrid CVSS ML predictor R²=0.91 · LLM observe→plan→act with deterministic fallback (no API key required)"/>
</picture>
</p>
...
| Metric | Value |
|---|---|
| 🧪 **Tests** | 2768 tests (pytest matrix: Python 3.11 / 3.12) |
...
tests/                    2768 pytest tests + native & DVWA benchmark suites
...
pytest tests/                  # full suite, ~3.5 min (2768 tests)
...
<p align="center">
<strong>2768 tests · 217 modules · 62 CLI commands · 99 API routes · 25 UI pages · PostgreSQL + SQLite · MIT</strong>
</p>
