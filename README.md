...
| Metric | Value |
|---|---|
| 🧪 **Tests** | 1163 tests (pytest matrix: Python 3.11 / 3.12) |
...
tests/                    1163 pytest tests + native & DVWA benchmark suites
...
<p align="center">
<strong>1163 tests · 148 modules · 50 CLI commands · 64 API routes · 24 UI pages · PostgreSQL + SQLite · MIT</strong>
