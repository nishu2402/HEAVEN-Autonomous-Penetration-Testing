...
| Metric | Value |
|---|---|
| 🧪 **Tests** | 819 tests (pytest matrix: Python 3.11 / 3.12) |
...
tests/                    819 pytest tests + native & DVWA benchmark suites
...
<p align="center">
<strong>819 tests · 137 modules · 47 CLI commands · 59 API routes · 22 UI pages · PostgreSQL + SQLite · MIT</strong>
</p>
