...
export default function AutonomousPage() {
  ...
  return (
    <div className="page">
      <div className="card">
        <h2 style={{ color: "var(--accent-2)", marginTop: 0 }}>⚙ Autonomous Loop</h2>
        ...
        <div className="scan-form" style={{ marginBottom: 4 }}>
          ...
          <label className="form-group">
            ...
            <input className="form-input" type="number" min={1} max={20} value={maxIter}
                   onChange={(e) => setMaxIter(e.target.value)} />
          </label>
          <label className="form-group">
            <span className="form-label">Time budget (seconds)</span>
            <input className="form-input" type="number" min={60} max={3600} value={budget}
        ...
        <button className="btn btn-primary" disabled={submitting || isRunning || !authorized} onClick={run}>
        ...
        <div className="card" style={{ marginTop: 12 }}>
          ...
          <table className="data-table" style={{ marginTop: 12 }}>
            <thead><tr>
              ...
              <th className="num">Reward</th><th>Rationale</th>
            </tr></thead>
            <tbody>
              {rows.map((r) => (
                <tr key={r.n}>
                  ...
                  <td className="num">{typeof r.reward === "number" ? r.reward.toFixed(2) : r.reward}</td>
