...
def test_sync_poster_matches_real_poster_markup():
    ...
    for poster in mod.POSTERS:
        ...
        # Hand-set figures survive the rewrite untouched (32 UI pages =
        # Sidebar.jsx's 31 nav entries + the Finding Detail route; 15 scan
        # modes = the SCAN_MODES array in scanModes.js).
        assert "32 UI pages, 15 scan modes" in bumped
