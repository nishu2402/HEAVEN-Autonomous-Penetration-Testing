...
``nehemiah.co.uk`` collapsed to the bare public suffix ``"co.uk"``, so SPF/DMARC
...
suffixes (``a.b.nehemiah.co.uk`` -> ``nehemiah.co.uk``) and returns ``None`` for a
bare suffix.
...
@pytest.mark.parametrize("host,expected", [
    ...
    ("nehemiah.co.uk", "nehemiah.co.uk"),
    ("www.nehemiah.co.uk", "nehemiah.co.uk"),
    ("a.b.nehemiah.co.uk", "nehemiah.co.uk"),
...
@pytest.mark.parametrize("host", [
    "nehemiah.co.uk", "www.example.com.au", "8.8.8.8", "192.168.2.0/24",
